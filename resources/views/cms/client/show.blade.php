...
@section('maintitle', 'Show Client')

@section('subtitle', 'Show Client')
...
@section('content')
    <div class="card card-info card-outline mb-4">
        ...
        <div class="card-header">
            <div class="card-title">Show data of Client</div>
        </div>
        <!--end::Header-->
        <!--begin::Form-->
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" disabled
                            value="{{ $clients->user->city->city_name ?? '' }}">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="address" disabled name="address"
                            value="{{ $clients->user->address ?? '' }}" required>
                    </div>
                    ...
                    {{-- <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="image" disabled name="image"
                            value="{{ $clients->user->image ?? '' }}">
                    </div> --}}


                    @if ($clients->user->image)
                        <img src="{{ asset('storage/images/client/' . $clients->user->image) }}" width="250"
                            class="img-thumbnail">
                    @else
