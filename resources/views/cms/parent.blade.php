...
<head>
    ...
    <link rel="preload" href="{ asset('cms/dist/css/adminlte.min.css') }" />
    ...
    <div class="app-wrapper">
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="./index.html" class="brand-link">
                    <!--begin::Brand Image-->
                    <img src="{{ asset('cms/dist/assets/img/AdminLTELogo.png') }}"
        ...
        <main class="app-main">
            ...
            <div class="app-content-header">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <h3 class="mb-0">@yield('maintitle')</h3>
                        </div>
                        <div class="col-sm-6">
        ...
        <footer class="app-footer">
            ...
            <strong>
                ...
                <a href="https://adminlte.io" class="text-decoration-none">{{ env('APP_NAME') }}
            </strong>
            All rights reserved.
            <!--end::Copyright-->
        </footer>
