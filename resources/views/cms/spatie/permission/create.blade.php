...
@section('title','create_permission')

@section('maintitle','create_permission')

@section('subtitle','create_permission')
...
@section('content')
  ...
  <div class="card-body">
    ...
    <label for="guard_name" class="form-label">permission Name</label>
