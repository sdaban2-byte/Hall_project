...
<div class="app-content">
          ...
          <div class="container-fluid" >
            ...
            <a href="{{ route('cities.create') }}" class="btn btn-primary" type="submit">Create new city</a>
            ...
            <div class="btn-group">
                ...
                <form action="{{ route('cities.destroy', $city->id) }}" method="POST" style="display:inline;"
                    ...
                    @csrf
                    @method('DELETE')
                    <button type="button" onclick="confirmDestroy({{ $city->id }}, this)" class="btn btn-sm btn-outline-danger" title="Delete">
...
<script>
   function confirmDestroy(id, reference) {
    destroy('/cms/admin/cities/' + id, reference);
}
</script>
