...
@section('title','edit_country')

@section('maintitle','edit_contry')

@section('subtitle','edit_country')
  ...
  <div class="card-body">
    <div class="row g-3">
      ...
      <div class="card-footer">
       <button class="btn btn-primary" type="button" onclick="performUpdate({{ $countries->id }})">Update</button>
